...
def responder_starts_puppet_over_1n(ctx):
    return (
        ctx.hand.hcp >= 10
...
class MeowPuppetStaymanOver1nGadget(Gadget):
    id = 'meow_puppet_stayman_over_1n'
    namespace = 'meow_2over1'
    name = 'Meow Puppet Stayman Over 1N'
    version = '0.1.0'
    description = 'Puppet Stayman over 1N as a dialogue flow: responder asks with 3C, opener answers, responder clarifies major interest, and opener places the contract when a precise fit is found.\n'
    ...
    def build(self):
        ...
        puppet.notrump_level = 1
        puppet.ask_requires = notrump_focus_active
        puppet.ask_applies = responder_starts_puppet_over_1n
        puppet.description = 'Responder uses 3C as game-forcing Puppet Stayman over 1N with at least one four-card major and no five-card major.'
        puppet.system_notes = 'After 1N, 3C is Puppet Stayman, game forcing, normally with a four-card major and no five-card major.'
        ...
        answer.system_notes = 'After 1N-3C, 3D denies a five-card major and shows at least one four-card major.'
        ...
        answer.system_notes = 'After 1N-3C, 3H shows a five-card heart suit.'
        ...
        answer.system_notes = 'After 1N-3C, 3S shows a five-card spade suit.'
        ...
        answer.system_notes = 'After 1N-3C, 3N denies a four- or five-card major.'

        continuation = puppet.continuation(after='3H', bid='4H', applies=responder_supports_hearts, final=True, target_suit='H')
        continuation.shows_length('H', min=3).records_fit('H', opener_min=5, responder_min=3, basis='puppet_1n_5_3_heart_fit')
        continuation.description = 'Responder raises opener five-card hearts to game with at least three-card support.'
        continuation.system_notes = 'After 1N-3C-3H, 4H places game with at least three-card heart support.'
        ...
        continuation.system_notes = 'After 1N-3C-3H, 3N denies three-card heart support.'

        continuation = puppet.continuation(after='3S', bid='4S', applies=responder_supports_spades, final=True, target_suit='S')
        continuation.shows_length('S', min=3).records_fit('S', opener_min=5, responder_min=3, basis='puppet_1n_5_3_spade_fit')
        continuation.description = 'Responder raises opener five-card spades to game with at least three-card support.'
        continuation.system_notes = 'After 1N-3C-3S, 4S places game with at least three-card spade support.'
        ...
        continuation.system_notes = 'After 1N-3C-3S, 3N denies three-card spade support.'
        ...
        continuation.system_notes = 'After 1N-3C-3D, 3H shows four spades and denies four hearts.'
        ...
        continuation.system_notes = 'After 1N-3C-3D, 3S shows four hearts and denies four spades.'
        ...
        continuation.system_notes = 'After 1N-3C-3D, 4D shows both majors and asks opener to choose.'

        resolution = puppet.resolution(after_answer='3D', after_continuation='3H', bid='4S', applies=opener_has_four_spades, target_suit='S')
        resolution.shows_length('S', value=4).records_fit('S', opener_min=4, responder_min=4, basis='puppet_1n_4_4_spade_fit')
        resolution.description = 'Opener places 4S with four spades opposite responder four spades.'
        resolution.system_notes = 'After 1N-3C-3D-3H, 4S confirms a 4-4 spade fit.'
        ...
        resolution.system_notes = 'After 1N-3C-3D-3H, 3N denies a spade fit.'

        resolution = puppet.resolution(after_answer='3D', after_continuation='3S', bid='4H', applies=opener_has_four_hearts, target_suit='H')
        resolution.shows_length('H', value=4).records_fit('H', opener_min=4, responder_min=4, basis='puppet_1n_4_4_heart_fit')
        resolution.description = 'Opener places 4H with four hearts opposite responder four hearts.'
        resolution.system_notes = 'After 1N-3C-3D-3S, 4H confirms a 4-4 heart fit.'
        ...
        resolution.system_notes = 'After 1N-3C-3D-3S, 3N denies a heart fit.'
        ...
        resolution.shows_length('S', value=4).records_fit('S', opener_min=4, responder_min=4, basis='puppet_1n_both_majors_spades')
        resolution.description = 'Opener chooses 4S with four spades when responder shows both majors.'
        resolution.system_notes = 'After 1N-3C-3D-4D, 4S chooses spades.'
        ...
        resolution.shows_length('H', value=4).records_fit('H', opener_min=4, responder_min=4, basis='puppet_1n_both_majors_hearts')
        resolution.description = 'Opener chooses 4H with four hearts and no four-card spade fit when responder shows both majors.'
        resolution.system_notes = 'After 1N-3C-3D-4D, 4H chooses hearts when opener lacks four spades.'
