...
# This file defines the active Partnership Profile.

class Meow2over1Profile(Profile):
    id = 'meow_2over1'
    name = 'Meow 2/1 Benchmark'
    version = '0.1.0'
    description = "Practical benchmark Partnership Profile for Meow Li's 2/1 agreements. This executable slice is organized as portable Gadgets plus profile-level Python policy functions: notrump openings, regular Stayman, Puppet Stayman stubs, four-way transfers, Texas transfers, standalone slam tools, simple major raises, Bergen, Drury, Jacoby 2N, Kokish game tries, minor opening continuations, checkback/XYZ, seat/vulnerability-sensitive preempts with Ogust/new-suit continuations, and strong 2C with 2D waiting.\n"
    author = Author('Meow Li')
    gadgets = [
        'meow_two_over_one_core',
        'meow_two_over_one_continuations',
        'meow_minor_opening_structure',
        'meow_strong_two_club',
        'meow_preemptive_openings',
        'meow_ogust_placement',
        'meow_gambling_3nt',
